  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      ...
      <md-table class="col-8" v-model="newQuiz.questions" md-card>
        <md-table-toolbar class="md-header my-3" data-background-color="blue">
          <h1
            class="md-title"
            style="color:white !important; text-shadow: gray 0 1px; font-weight: 500;"
    ...
    <div class="row justify-content-center">
      <div class="col-8 md-card">
        <div
          class="md-toolbar md-table-toolbar md-transparent md-header my-3 md-theme-default md-elevation-0"
          data-background-color="purple"
        >
          <h1
            class="md-title"
            style="color: white !important; text-shadow: gray 0px 1px; font-weight: 500;"
          >Confirm Quiz Details</h1>
        </div>
